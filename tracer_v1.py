...
the_quary = ("Read the text that contains a list of ideams about mathematics teaching. Your task is to analyze the text and identify recurring themes present in it. To do this, first read the contents of the text and extract meaningful patterns that help researchers understand and describe the ideas. Then, return the top 4 most central aspects or common threads connecting various ideas focusing on teaching and assessment. Please provide the results in a clear and concise manner, including the theme. For teach theme provide a definition, so that the it is understood what the theme is refering to.")
#embeddings_content = construct_index_content(theme_analysis, api)
combine_text_files()
loader = TextLoader('themes.txt')
index = VectorstoreIndexCreator().from_loaders([loader])

#response_content = content_2(the_quary)
output_content = index.query(the_quary)
